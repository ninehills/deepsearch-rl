...
if __name__ == "__main__":
    ...
    if args.chunk_by == "token":
        ...
        chunker = chonkie.RecursiveChunker(
            tokenizer_or_token_counter=args.tokenizer_name_or_path, chunk_size=args.chunk_size, min_characters_per_chunk=args.chunk_size/2
        )
    else:
    ...
    for doc in tqdm(documents):
        ...
        metadata["doc_chunks"] = len(chunks)
